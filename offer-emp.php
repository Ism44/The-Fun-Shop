        ...
        <div class="row">
          ...
          <div class="col" id="signup" style="align-content:center;">
            <input class="cred" type="text" name="Employee_id" placeholder="Emp-id" required>
              <input class="cred" type="text" name="Offer_name" placeholder="Offer name" required>
              <input class="cred" type="text" name="time_period" placeholder="from DD/MM/YY to DD/MM/YY" required>
              <input class="cred" type="text" name="Discount" placeholder="%off" required>
          </div>
