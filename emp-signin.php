        ...
        <div id="main-body">
            ...
            <div class="content">
              <form action="emplogin.php" method="post">
                <div class="row">
                  <h2 style="text-align:center">Login as an Employee or sign up</h2>
              ...
              <div class="bottom-container">
                <div class="row">
                  <div class="col">
                    <a href="emp-signup.php" style="color:white" class="btn">Sign up</a>
                  </div>
                  <div class="col">
                    <a href="login.php" style="color:white" class="btn">Log in as a user</a>
                  </div>
                </div>
              </div>
