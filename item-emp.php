    ...
    <div class="content">
      <form action="insertitem.php" method="post">
        <div class="row">
          ...
          <input class="cred" type="text" name="Employee_id" placeholder="Emp-id" required>
            <input class="cred" type="text" name="item_name" placeholder="item name" required>
            <input class="cred" type="text" name="item_price" placeholder="00EGP" required>
            <input class="cred" type="text" name="item_availability" placeholder="available/not available/ coming soon/etc" required>
