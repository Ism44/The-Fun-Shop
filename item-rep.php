...
<form action="checkout.php" method="get">
    <div class="background">
      <!--Your code goes here-->
      <div class='orderU'>
          <table border="1"> <tr> <th>id</th> <th>item name</th><th>price</th><th>availability</th> </tr>
            <?php
    ...
    <div class="row">
      <div>
        <a href="item-emp.php" style="color:white; text-align:center;" class="btn">Add an item</a>
      </div>
