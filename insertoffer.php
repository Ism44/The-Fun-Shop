...
$stmt="INSERT INTO `offers`( `Employee_id`,`Offer_name`,`time_period`,`Discount`) VALUES('$Employee_id','$Offer_name','$time_period','$Discount')";
      $result= mysqli_query($conn, $stmt);
      if ($result==FALSE) {
        echo "Error $Offer_name was not added";
      }
      else {
        echo "$Offer_name was successfully added";
      }
      ?>
</div>
